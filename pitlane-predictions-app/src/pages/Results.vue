...
import { fetchPredictionResults } from '@/dummy_data/actions.js';
...
function _fetchPredictionResults() {
    errorMessage.value = null;
    
    if (!isFutureEvent.value)
        return fetchPredictionResults(props.user.id, props.league.id, calendarEvent?.value.country, year.value).then(_predictions => {
...
function changeTrack() {
    ...
    return _fetchPredictionResults();
}
</script>
...
<div id="Results" class="page-container">
    <div class="page-title">
        {{ props.league?.name || 'the League' }} Prediction Results
    </div>
